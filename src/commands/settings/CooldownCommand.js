      ...
      default:
        return message.channel.send(
          new MessageEmbed()
            ...
            .addField('Настройка', 'Подробную справку по настройке задержек для команд вы сможете получить на [этой странице](https://docs.flamebot.ru/abilities/economy).', true)
