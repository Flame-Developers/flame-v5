      ...
      default:
        message.channel.send(
          new MessageEmbed()
            ...
            .addField('Настройка модуля', 'Подробную справку по настройке данной системы вы сможете получить на [этой странице](https://docs.flamebot.ru/settings/auto-moderation/anti-invite).')
