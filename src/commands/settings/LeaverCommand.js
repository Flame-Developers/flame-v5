      ...
      default:
        return message.channel.send(
          new MessageEmbed()
            ...
            .addField('Настройка модуля', 'Подробную справку по настройке данного модуля вы можете получить на [этой странице](https://docs.flamebot.ru/settings/members/leaver).')
